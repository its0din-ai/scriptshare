            ...
            <div class="row border rounded-5 p-3 shadow box-area">
                ...
                <div class="col-md-4 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                    ...
                    <div class="feature-image mb-3">
                        ...
                        <p class="text-white fs-2" style="font-family: 'courier new', courier, monospace; font-weight: 600;">Wellcome Back</p>
                        <small class="text-white text-wrap text-center" style="width: 17rem; font-family: 'courier new', courier, monospace;">Login to access your
                            account</small>
                    </div>
                </div>
                <!-- kanan -->
                    ...
                    <div class="row align-items-center">
                        ...
                        <form method="POST">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control form-control-lg bg-light fs-6" id="username" type="username" name="username" required autocomplete="username" placeholder="username">
                            </div>
                            <!-- input password -->
...
<div class="mobile">
    ...
    <div class="container ms-auto me-auto d-flex justify-content-center align-items-center min-vh-60 div-mobile login" id="">
        <div class="" style="max-width: 500px;">
            <div class="row border rounded-5 p-3 shadow box-area">
                ...
                <div class="col-md-4 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                    <!-- image -->
                    <div class="feature-image mb-3">
                        <img src="./public/img/login.svg" class="img-fluid rounded-start mb-3" alt="brand" style="width: 150px;">
                        <p class="text-white fs-2 mb-n3" style="font-family: 'courier new', courier, monospace; font-weight: 300;">Be Verified</p>
                        <small class="text-white text-wrap text-center" style="width: 2rem; font-family: 'courier new', courier, monospace;">Join with Us on this
                            platform</small>
                    </div>
                </div>
                <!-- kanan -->
