            ...
            <div class="row border rounded-5 p-3 shadow box-area">
                ...
                <div class="col-md-4 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                    ...
                    <div class="feature-image mb-3">
                        ...
                        <small class="text-white text-wrap text-center" style="width: 17rem; font-family: 'courier new', courier, monospace;">Join with Us on this
                            platform</small>
                    </div>
                </div>
                <!-- kanan -->
...
<div class="mobile">
    ...
    <div class="container ms-auto me-auto d-flex justify-content-center align-items-center min-vh-60 div-mobile" id="">
        <div class="" style="max-width: 500px;">
            <div class="row border rounded-5 p-3 shadow box-area">
                ...
                <div class="col-md-4 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                    <!-- image -->
                    <div class="feature-image mb-3">
                        <img src="./public/img/login.svg" class="img-fluid rounded-start" alt="brand" style="width: 150px;">
                        <p class="text-white fs-2" style="font-family: 'courier new', courier, monospace; font-weight: 600;">Be Verified</p>
                ...
                <div class="col-md-4 right-box">
                    <div class="row align-items-center">
                        <div class="header-text mb-4 mt-2 ">
                            <h5 style="color: var(--blue);">Login / Sign Up</h5>
                        </div>
