                ...
                <div class="row border rounded-5 p-3 shadow box-area">
                    ...
                    <div class="col-md-4 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                        ...
                        <div class="feature-image mb-3">
                            ...
                            <p class="text-white fs-2 mb-n3" style="font-family: 'courier new', courier, monospace; font-weight: 300;">
                                Be Verified</p>
                            <small class="text-white text-wrap text-center" style="width: 2rem; font-family: 'courier new', courier, monospace;">Join
                                with Us on this
                                platform</small>
                        </div>
                    </div>
