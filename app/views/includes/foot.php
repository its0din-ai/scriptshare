        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="d-flex justify-content-left">
                    <ul style="list-style: none; padding-left: 0px;">
                        <li><img src="/public/img/brand-lg.png" class="rounded" style="width: 130px;" /></li>
                        <li class="mt-3">
                            <p>2023 - TEKNIK INFORMATIKA
                                <br><span class="text-info"><strong>UNIVERSITAS MUHAMMADIYAH SURAKARTA</strong></span>
                            </p>
                        </li>
                    </ul>
                </div>
